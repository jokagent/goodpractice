...
class Ion_auth_model extends CI_Model
{
	...
	public function register($username, $password, $email, $additional_data = array(), $groups = array())
	{
		...
		if ( $this->email_check($email)) //$this->identity_column == 'email' &&
		{
			$this->set_error('account_creation_duplicate_email');
			return FALSE;
		}
//		elseif ($this->username_check($username)) //$this->identity_column == 'login' &&
//		{
...
//		}
	...
	**/
	 ...
	 * @author Ben Edmunds
	 **/
	public function set_lang($lang = 'ru')
	{
	...
	public function login_remembered_user()
	{
		...
		//get the user
		$this->trigger_events('extra_where');
		$query = $this->db->select($this->identity_column.', id, login, email, last_login')
