 ...
 */
$config['site_title']                 = "goodpractice.ru";       // Site Title, example.com
$config['admin_email']                = "info@goodpractice.ru"; // Admin Email, admin@example.com
 ...
 */
$config['use_ci_email'] = true; // Send Email using the b uiltin CI email class, if false it will return the code and the identity
 ...
 */
$config['email_forgot_password'] = 'forgot_password';
 ...
 */
$config['email_forgot_password_complete'] = 'new_password';
